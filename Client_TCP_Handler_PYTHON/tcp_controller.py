...
Acts as the connection between the python code and the RAPID TCP base
...
class six_axis_tcp_base():
    ...
    Keyword Args:
        ...
        valid_CMD_dict - A dictionary containing the valid commands to send over the TCP connection
    """
